...
class TargetNodeController {
    ...
    def list(Integer max) {
        ...
        [nodeInstanceList: TargetNode.list(params), nodeInstanceTotal: TargetNode.count()]
    }

    def create() {
        [nodeInstance: new TargetNode(params)]
    }

    def save() {
        def nodeInstance = new TargetNode(params)
    ...
    def show(Long id) {
        def nodeInstance = TargetNode.get(id)
        if (!nodeInstance) {
