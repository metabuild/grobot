 ...
 */
@Configuration
@ComponentScan(basePackages = {"org.metabuild.grobot.server", "org.metabuild.grobot.webapp.domain"})
...
public class AppConfig {
	...
	@Bean
	public String getServerActiveMq() {
		return environment.getProperty("grobot.server.activemq.port");
	}
}